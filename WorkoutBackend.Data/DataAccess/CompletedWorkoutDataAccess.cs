...
public static class CompletedWorkoutDataAccess
{
    ...
    public static string GetCompletedWorkoutsSummaries => DataAccessHelper.GetSqlString(sqlFolder, "GetCompletedWorkoutsSummaries.sql");
    ...
    public static string UpdateCompletedWorkoutById => DataAccessHelper.GetSqlString(sqlFolder, "UpdateCompletedWorkoutById.sql");
